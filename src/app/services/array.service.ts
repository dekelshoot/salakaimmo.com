...
popularWords= ["Maison à vendre","Maison meublé","Terrain","Appartement à louer","Appartement meublé","Appartement à vendre","Chambre à louer","Chambre meublé",'Studio à louer','Studio meublé','Boutique', 'Fond de commerce',"Usine","Entrepot","Magasin","BTP","Lotissement",'Autre']
